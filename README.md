<p align="center">
  <a href="https://blog.klair.co"><img src="src/images/github-header.png" /></a>
 </p>
<p align="center">
  <strong>🍭 My blog built with <a href="http://gatsbyjs.org">Gatsby</a> + TypeScript. Neat.</strong>
</p>
<p align="center">
  <a href="https://blog.klair.co">blog.klair.co</a>
</p>
<p align="center">
  <a href="https://travis-ci.com/perminder-klair/blog.klair.co"><img src="https://travis-ci.com/perminder-klair/blog.klair.co.svg?branch=master" /></a>
  <a href="https://codeclimate.com/github/perminder-klair/blog.klair.co/maintainability"><img src="https://api.codeclimate.com/v1/badges/4e86c791349cd12368cd/maintainability" /></a>
  <a href="https://codeclimate.com/github/perminder-klair/blog.klair.co/test_coverage"><img src="https://api.codeclimate.com/v1/badges/4e86c791349cd12368cd/test_coverage" /></a>
...
The whole [blog](https://blog.klair.co) is a React-based Single Page App built with [Gatsby v2](https://www.gatsbyjs.org).
...
See it live on [Matomo plugin for Gatsby](https://blog.klair.co/gatsby-plugin-matomo#changelog).
...
```bash
git clone git@github.com:perminder-klair/blog.klair.co.git
cd blog/
