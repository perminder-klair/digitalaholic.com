...
const feedContent = (edge) => {
  ...
  const footer =
    '<hr />This post was published on <a href="https://blog.klair.co">klair.co</a>'
...
const createJsonFeed = (posts) => ({
  ...
  user_comment:
    'This feed allows you to read the posts from this site in any feed reader that supports the JSON Feed format. To add this feed to your reader, copy the following URL — https://blog.klair.co/feed.json — and add it your reader.',
